...
Hartvig Solutions ("we", "our", or "us") operates the PocketCoach mobile application. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
...
### Analytics (Firebase)
We use Google Firebase Analytics to track app usage and technical errors. This helps us improve the app and fix bugs.
